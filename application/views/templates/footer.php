...
<div id="musicPlayerFooter" class="fixed-bottom bg-white border-top border-dark shadow-lg align-items-center justify-content-between px-3 py-2" style="z-index: 9999; min-height: 70px; display: none;">
  ...
  <div class="d-flex align-items-center gap-2">
    ...
    <button id="playerClose" class="btn btn-outline-danger btn-sm ms-2" title="Hide player"><i class="bi bi-x-lg"></i></button>
  </div>
</div>
